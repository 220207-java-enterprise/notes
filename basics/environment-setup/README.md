...
> ![#f03c15](https://via.placeholder.com/15/f03c15/000000?text=+) Important! If you are on a Mac, please follow the environment guidelines in the [Mac Environment Setup Guide](https://github.com/220207-java-enterprise/notes/blob/main/basics/environment-setup/mac-setup.md). 
...
- [**IntelliJ Community Edition**](#step-3-install-intellij): We will be using IntelliJ from JetBrains as our *integrated development environment* (IDE). Though you don't need an IDE to write code, an IDE provides several features that make rapid development (e.g. quickly writing and refactoring code) easier.
...
## Step 3: Install IntelliJ Community Edition

1. Navigate to the [IntelliJ Community](https://www.jetbrains.com/idea/download/#section=windows) website and download the Community Edition executable. 
